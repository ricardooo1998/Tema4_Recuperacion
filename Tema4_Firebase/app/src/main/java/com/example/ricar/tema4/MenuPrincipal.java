...
public class MenuPrincipal extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //EXAMEN
        final Button seguir = findViewById(R.id.seguir);
        seguir.setOnClickListener(this);

        final Button misSeguidores = findViewById(R.id.misSeguidores);
        misSeguidores.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        //EXAMEN
        if (v.getId()==R.id.seguir)
        {
            Intent i = new Intent(getApplicationContext(), Seguir.class);
            startActivity(i);
        }

        if (v.getId()==R.id.misSeguidores)
        {
            Intent i = new Intent(getApplicationContext(), MisSeguidores.class);
            startActivity(i);
        }
    }
